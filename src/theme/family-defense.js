...
/**
 * family-defense theme — built by `npx astryx theme build`
 * Import the CSS file alongside this module:
 *
 *   import { familyDefenseTheme } from './family-defense';
 *   import './family-defense.css';
 */
export const familyDefenseTheme = {
  name: 'family-defense',
  __built: true,
  tokens: {
    ...
    "--font-size-3xl": "2.6875rem",
    "--font-size-4xl": "3.4375rem",
    ...
    "--font-family-body": "\"Source Sans 3 Variable\", -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, sans-serif",
    "--font-family-heading": "\"Source Serif 4 Variable\", Georgia, \"Times New Roman\", serif",
    ...
    "--color-background-surface": "light-dark(#FAFCFF, #161C25)",
    "--color-background-body": "light-dark(#F8F6F2, #141517)",
    "--color-background-card": "light-dark(#FAFCFF, #161C25)",
    "--color-background-popover": "light-dark(#FAFCFF, #2B313A)",
    "--color-background-muted": "light-dark(#161C250D, #161C2580)",
    "--color-accent": "light-dark(#0063A8, #A0C9FF)",
    ...
    "--color-neutral": "light-dark(#161C251A, #DCE3F033)",
    "--color-overlay": "light-dark(#161C2566, #161C2599)",
    "--color-overlay-hover": "light-dark(#161C250D, #FFFFFF0D)",
    "--color-overlay-pressed": "light-dark(#161C251A, #FFFFFF1A)",
    "--color-text-primary": "light-dark(#161C25, #DCE3F0)",
    "--color-text-secondary": "light-dark(#3E4756, #A2ACBD)",
    "--color-text-disabled": "light-dark(#8791A2, #555F6E)",
    "--color-text-accent": "var(--color-accent)",
    "--color-on-dark": "#ffffff",
    "--color-on-light": "#171717",
    "--color-on-accent": "light-dark(#FFFFFF, #003467)",
    ...
    "--color-icon-primary": "light-dark(#161C25, #DCE3F0)",
    "--color-icon-secondary": "light-dark(#3E4756, #A2ACBD)",
    "--color-icon-disabled": "light-dark(#8791A2, #555F6E)",
    ...
    "--color-border": "light-dark(#161C251A, #EAF1FE1A)",
    "--color-border-emphasized": "light-dark(#A2ACBD, #3E4756)",
    "--color-skeleton": "light-dark(#A2ACBD, #3E4756)",
    ...
    "--color-background-inverted": "light-dark(#161C25, #FAFCFF)",
    "--color-track": "light-dark(#A2ACBD, #3E4756)",
    "--radius-chat": "6px"
  },
