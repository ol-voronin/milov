...
export function PageHero({
  ...
  cta?: boolean;
  /**
   * Тема звернення, передвибрана у формі. Якщо людина відкриває заявку
   * зі сторінки про затримку виплати, питати її ще раз «яка у вас тема»
   * безглуздо — відповідь уже видно з того, що вона читала.
   * Це прибирає один клік із трьох, які лишилися у формі.
   */
  topic?: string;
  /**
