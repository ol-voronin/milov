...
export function KnowledgeHub() {
  ...
  return (
    <VStack gap={8}>
      ...
      {/* Блок «Не знайшли відповідь?» прибрано: одразу під ним іде
          «Розділи сайту за темами» з тим самим закликом до дії, і два
          заклики поспіль знецінювали один одного. Питання можна
          поставити звідти. */}
    </VStack>
  );
}
