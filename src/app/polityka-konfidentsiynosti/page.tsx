      ...
      <Section variant="transparent" padding={8} paddingBlock={8}>
        <Container gap={6}>
          ...
          <VStack gap={3}>
            ...
            <Text as="p" type="body" color="secondary">
              Ми ведемо знеособлений підрахунок переглядів сторінок: скільки
              разів відкрито ту чи іншу сторінку і з якого типу пристрою. Ці
              дані не використовують файли cookie, не дозволяють упізнати
              конкретну людину й не містять вмісту ваших звернень.
            </Text>
            <ReviewNote>
