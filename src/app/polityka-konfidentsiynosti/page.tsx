      ...
      <Section variant="transparent" padding={8} paddingBlock={8}>
        <Container gap={6}>
          ...
          <VStack gap={3}>
            ...
            <Text as="p" type="body" color="secondary">
              Сайт не використовує рекламних трекерів і не передає ваші дані
              рекламним системам.
            </Text>
            <Text as="p" type="body" color="secondary">
              У памʼяті вкладки браузера тимчасово зберігається технічна
              позначка про те, з якого джерела ви потрапили на сайт: назва
              пошукової системи, домен сайту з посиланням або мітка рекламної
              кампанії. Це потрібно, щоб розуміти, які матеріали справді
              допомагають людям нас знайти. Позначка не містить ваших
              персональних даних і не дає змоги впізнати вас під час
              наступного візиту — вона зникає, щойно ви закриєте вкладку.
            </Text>
            <Text as="p" type="body" color="secondary">
              Якщо буде підключено знеособлену аналітику відвідуваності, вона
              не отримуватиме вміст ваших звернень.
            </Text>
            <ReviewNote>
