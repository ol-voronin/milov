...
export const metadata: Metadata = {
  /**
   * Бренд дописано вручну: шаблон `%s — Заступа` з layout.tsx діє лише на
   * дочірні сегменти, а головна лежить у тому самому сегменті, що й layout,
   * тому шаблон до неї не застосовується.
   */
  title: 'Заступа — права родин військовослужбовців: виплати, документи, захист',
  description:
