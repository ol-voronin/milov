...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Зниклі безвісти та полонені — права родини — Заступа',
    description:
      'Права родини зниклого безвісти або полоненого: грошове забезпечення, юридичні факти, захист від шахраїв.',
  },
};
