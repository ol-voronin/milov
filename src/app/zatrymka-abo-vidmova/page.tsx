...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Відмовили або затримують виплату? — Заступа',
    description:
      'Як зафіксувати бездіяльність, оскаржити відмову і які кроки реально зрушують справу з виплатами родині військового.',
  },
};
