...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Виплати родині загиблого військового — Заступа',
    description:
      'Хто має право на виплати, які документи потрібні, що робити при затримці або відмові. Юридична допомога по всій Україні.',
  },
};
