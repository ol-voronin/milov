...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: 'Команда юристів — Заступа',
    description:
      'Хто працює з вашою справою: досвід, напрями роботи та можливість перевірити статус спеціаліста.',
  },
};
  ...
  return (
    <>
      ...
      <PageHero
        ...
        statement="За кожним напрямом закріплена конкретна людина. Ви знатимете, хто веде вашу справу, ще до початку роботи."
      />
      ...
      <Section variant="transparent" padding={8} paddingBlock={10}>
        <Container gap={4}>
          ...
          {/* Межа спеціалізації. Сказати про це прямо дешевше, ніж
              приймати дзвінки, які закінчаться «ми цим не займаємось»:
              людина втрачає день, а родина, яка чекає на лінії, — юриста. */}
          <div className="scope-note">
            <VStack gap={2}>
              ...
              <Text as="p" type="body" color="secondary" textWrap="pretty">
                Ми працюємо з правами родин військовослужбовців. Справи самого
                військовослужбовця — СЗЧ, ВЛК, оскарження висновків щодо
                придатності, звільнення та переведення — це інша спеціалізація,
                і ми за них не беремося. Якщо ваше питання про це, ми чесно
                скажемо про це в першу хвилину розмови, щоб ви не втрачали час.
              </Text>
            </VStack>
          </div>
        </Container>
